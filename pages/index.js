    ...
    <Layout>
      <div className="mt-16 mb-16">
        ...
        <p className="font-body text-gray-700">
          Ik ben Tom Oostewechel, productontwikkelaar bij Jouw Omgeving in
          Utrecht. Ik schrijf over projecten en het ontwerpproces, maak complexe
          vraagstukken uit de zorg op een creatieve en visuele wijze
