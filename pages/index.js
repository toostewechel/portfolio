          ...
          <main>
            <div className="mt-16 mb-16">
              ...
              <p className="font-body text-gray-700">
                ...
                Utrecht. Ik maak complexe vraagstukken op een creatieve en
                visuele wijze inzichtelijk en combineer kennis uit verschillende
                domeinen en vertaal deze naar duurzame en gebruiksvriendelijke
                oplossingen. Op deze site schrijf ik over projecten, het
                ontwerpproces en gerelateerde onderwerpen.
              </p>
            </div>
